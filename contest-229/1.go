...
func maximumScore(nums []int, multipliers []int) int {
	...
	var dfs func(l, r, j int) int
	dfs = func(l, r, j int) int {
		if j == m {
			return 0
		}
		if memo[l][r][j] != math.MinInt32 {
			return memo[l][r][j]
		}
		// 左边或者右边
		left := nums[l] * multipliers[j]
		right := nums[r] * multipliers[j]
		ret := max(left+dfs(l+1, r, j+1), right+dfs(l, r-1, j+1))
		memo[l][r][j] = ret
		// fmt.Println(l, "-", r, "-", j, "has", ret)
		return ret
	}
	ans := dfs(0, n-1, 0)
